Sequence to Sequence Speech Recognition System based on [Listen Attend and Spell](https://arxiv.org/abs/1508.01211). The encoder used pyramidal bi-LSTM (pBLSTM) which obtains 
